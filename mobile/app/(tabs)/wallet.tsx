  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}
      ...
      <View style={styles.actionRow}>
        <Button title="Fund Wallet" onPress={() => setShowFund(true)} variant="primary" size="sm" />
        {user?.role === 'errander' && <Button title="Withdraw" onPress={() => setShowWithdraw(true)} variant="secondary" size="sm" />}
      </View>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: 'bold', color: colors.neutral[600], marginBottom: 16 },
  ...
  txType: { fontSize: 14, color: colors.neutral[600], maxWidth: 200 },
  ...
  input: { backgroundColor: colors.neutral[50], borderWidth: 1, borderColor: colors.neutral[200], borderRadius: theme.radius.md, padding: 14, fontSize: 16, color: colors.neutral[600], marginBottom: 12 },
