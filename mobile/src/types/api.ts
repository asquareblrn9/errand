...
export interface RegisterPayload { name: string; email: string; phone: string; password: string; password_confirmation: string; role: 'requester' | 'errander'; device_type?: string; }
export interface AuthResponse { user: UserData; token: string; token_type: string; refresh_token: string; expires_at: string; requires_email_verification?: boolean; }
